...
# === CONFIG ===
json_file = 'movie_recommendation.json'  # Replace with your path
...
if __name__ == "__main__":
    ...
    write_results_to_csv(all_results, "evaluation_results_movie_recommendation.csv")
    print("Results saved to movie_recommendation.csv")