...
# === CONFIG ===
json_file = 'tracking_shuffled_objects_seven_objects.json'  # Your dataset
...
if __name__ == "__main__":
    ...
    write_results_to_csv(all_results, f"evaluation_results__tracking_{start_index}.csv")

    with open("checkpoint_tracking.txt", "w") as f:
